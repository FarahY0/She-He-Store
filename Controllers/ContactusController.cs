...
namespace HeAndSheStore.Controllers
{
    public class ContactusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Contactusid,Address,Email,Maplocation,Imagepath,Subject,Message,Name,Phone")] Contactu contactu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Contactusid,Address,Email,Maplocation,Imagepath,Subject,Message,Name,Phone")] Contactu contactu)
        {
