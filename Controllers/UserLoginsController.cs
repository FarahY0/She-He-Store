...
namespace HeAndSheStore.Controllers
{
    public class UserLoginsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,Password,Email,Userid")] UserLogin userLogin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,UserName,Password,Email,Userid")] UserLogin userLogin)
        {
            if (id != userLogin.Id)
            {
                return NotFound();
